...
def get_random_fact():
    try:
        ...
        return fact if fact else "Unable to fetch random fact at the moment."
    except Exception as e:
        print(f"An error occurred: {e}")
        return "Unable to fetch random fact at the moment."
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "random fact" in query:
            random_fact = get_random_fact()
            say("Here's a random fact for you:")
            say(random_fact)
